...
import { shouldQueueSport80Event } from '../tasks/scrapeSport80EventsTask.js';
...
describe('source freshness policy', () => {
    ...
    it('retries pending/failed Sport80 state immediately and refreshes processed state when stale', () => {
    ...
    it('lets force override freshness', () => {
        expect(shouldQueueSport80Event({
            status: 'processed',
            processedAt: now,
        }, {
